...
namespace Chanto
{
	public class BaseConfig : BaseTable
    {
        ...
        protected override void LoadTable()
        {
            ...
            if (this.IsLoading())
            {
                Log.WarningFormat("the table {0} is loading, please wait...", this.GetTableFileName());
                return;
            }
            ...
            {
                Log.ErrorFormat("The file {0} is not load, please check config assetbundle", this.GetTableFileName());
                return;
            }
#endif
        ...
        protected override void LoadIndex()
        {
            ...
            {
                Log.ErrorFormat("The file {0} is not load, please check config assetbundle", this.GetIndexFileName());
            }
#endif
        ...
        {
            return Path.Combine("./Assets/Main/Config/", this.GetDataFileName());
        }

        protected override string GetIndexFile()
        {
            return Path.Combine("./Assets/Main/Config/ids", this.GetIndexFileName() + ".bytes");
        }
