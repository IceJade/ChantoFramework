        ...
        protected override void LoadIndex()
        {
            ...
            using (UnityWebRequest request = UnityWebRequest.Get(filepath))
            {
                ...
                while (!request.downloadHandler.isDone)
                {
                    ...
                    {
                        Log.Error($"Load {request.url} fail, error mssage : {request.error}");
                        return;
                    }
                    ...
                    {
                        Log.Error($"Load table {filepath} time out.");
                        return;
                    }
            ...
            {
                Log.Error($"Read table {filepath} exception, error msg : {e.Message}");
            }
#endif
#endif
