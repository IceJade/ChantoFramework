namespace Framework.Sound
{
    ...
    public sealed class PlaySoundParams
    {
        ...
        {
            m_Time = SoundDefine.DefaultTime;
            m_MuteInSoundGroup = SoundDefine.DefaultMute;
            m_Loop = SoundDefine.DefaultLoop;
            m_Priority = SoundDefine.DefaultPriority;
            m_VolumeInSoundGroup = SoundDefine.DefaultVolume;
            m_FadeInSeconds = SoundDefine.DefaultFadeInSeconds;
            m_Pitch = SoundDefine.DefaultPitch;
            m_PanStereo = SoundDefine.DefaultPanStereo;
            m_SpatialBlend = SoundDefine.DefaultSpatialBlend;
            m_MaxDistance = SoundDefine.DefaultMaxDistance;
            m_DopplerLevel = SoundDefine.DefaultDopplerLevel;
        }
