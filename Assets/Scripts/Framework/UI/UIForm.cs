...
namespace Framework.UI
{
    ...
    public sealed class UIForm : MonoBehaviour
    {
        ...
        public void OnInit(int serialId, string uiFormAssetName, UIGroup uiGroup, bool pauseCoveredUIForm, object userData)
        {
            rectTransform = GetComponent<RectTransform>();
			m_SerialId = serialId;
            ...
            {
                Log.ErrorFormat("UI form '{0}' can not get UI form logic.", uiFormAssetName);
                return;
            }
        ...
        {
            UsedObjectPool.DestoryObject(gameObject);
        }
