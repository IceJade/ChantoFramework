...
namespace UnityFramework.Runtime
{
    ...
    public sealed class NetworkCustomErrorEventArgs : GameEventArgs
    {
        ...
        public static NetworkCustomErrorEventArgs Create(Framework.Network.NetworkCustomErrorEventArgs e)
        {
            NetworkCustomErrorEventArgs networkCustomErrorEventArgs = LogicPoolManager.Instance.Spawn<NetworkCustomErrorEventArgs>();
