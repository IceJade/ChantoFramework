...
namespace UnityFramework.Runtime
{
    ...
    public sealed class NetworkMissHeartBeatEventArgs : GameEventArgs
    {
        ...
        public static NetworkMissHeartBeatEventArgs Create(Framework.Network.NetworkMissHeartBeatEventArgs e)
        {
            NetworkMissHeartBeatEventArgs networkMissHeartBeatEventArgs = LogicPoolManager.Instance.Spawn<NetworkMissHeartBeatEventArgs>();
