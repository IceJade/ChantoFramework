...
namespace UnityFramework.Runtime
{
    ...
    public sealed class NetworkErrorEventArgs : GameEventArgs
    {
        ...
        public static NetworkErrorEventArgs Create(Framework.Network.NetworkErrorEventArgs e)
        {
            NetworkErrorEventArgs networkErrorEventArgs = LogicPoolManager.Instance.Spawn<NetworkErrorEventArgs>();
